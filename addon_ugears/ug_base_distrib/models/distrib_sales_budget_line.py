...
class DistributorSaleBudgetLine(models.Model):
    ...
    move_id = fields.Many2one(
        comodel_name='distrib.budget.move',
        string="Distributor Budget Reference",
    ...
    currency_id = fields.Many2one(
        ...
        store=True, index=True, precompute=True)
    date = fields.Datetime(related='move_id.date', string="Move Data", store=True, precompute=True)
    ...
    product_no_variant_attribute_value_ids = fields.Many2many(
        ...
        relation='distrib_budget_attribute_value_ids',
        string="Extra Values",
    ...
    def _compute_product_uom_qty(self):
        for line in self:
            ...
            line.product_uom_qty2 = 0.0
            line.product_uom_qty3 = 0.0
            line.product_uom_qty4 = 0.0
            line.product_uom_qty5 = 0.0
            line.product_uom_qty6 = 0.0
            line.product_uom_qty7 = 0.0
            line.product_uom_qty8 = 0.0
            line.product_uom_qty9 = 0.0
            line.product_uom_qty10 = 0.0
            line.product_uom_qty11 = 0.0
            line.product_uom_qty12 = 0.0
    ...
    def _get_pricelist_price(self):
        ...
        order_date = self.move_id.date or fields.Date.today()
    ...
    def _compute_amount(self):
        for line in self:
            line.qtt_total = (
                    ...
                    + line.product_uom_qty2
                    + line.product_uom_qty3
                    + line.product_uom_qty4
                    + line.product_uom_qty5
                    + line.product_uom_qty6
                    + line.product_uom_qty7
                    + line.product_uom_qty8
                    + line.product_uom_qty9
                    + line.product_uom_qty10
                    + line.product_uom_qty11
                    + line.product_uom_qty12
            )
            line.price_total = line.price_unit * line.qtt_total
