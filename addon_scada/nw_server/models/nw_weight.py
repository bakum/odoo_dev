...
class Weight(models.Model):
    ...
    value3 = fields.Float('Platform #2', required=False, default=0)
    value4 = fields.Float('Platform #3', required=False, default=0)
    value5 = fields.Float('Platform #4', required=False, default=0)
    cross_platform_shift= fields.Float('Cross-platform shift', required=False, default=0)
