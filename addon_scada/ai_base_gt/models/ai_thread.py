...
class AIThread(models.Model):
    ...
    def _create_tool_result(self, prompt, func_call, func_res):
        ...
        vals = {
            'thread_id': self.id,
            'message_type': 'system',
            'func_call': json.dumps(func_call, ensure_ascii=False, indent=2, default=date_utils.json_default),
            'func_result': json.dumps(func_res, ensure_ascii=False, indent=2, default=date_utils.json_default),
        ...
        if config.type == 'odooai':
            vals['content'] = (
                ...
                json.dumps(func_res, ensure_ascii=False, indent=2, default=date_utils.json_default),
